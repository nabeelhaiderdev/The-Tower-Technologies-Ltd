...
if ( ! function_exists( 'glide_setup_function' ) ) {
	...
	function glide_setup_function() {
		...
		register_nav_menus(
			array(
				'header-nav'   => __( 'Header Nav', 'ttl_td' ),
				'footer-nav-one' => __( 'Footer Nav One', 'ttl_td' ),
				'footer-nav-two' => __( 'Footer Nav Two', 'ttl_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'ttl_td' ),
				'legal-nav' => __( 'Legal Nav', 'ttl_td' ),
			)
		);
...
function glide_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Required Plugins', 'ttl_td' ),
            'menu_title'                      => __( 'Plugin Installer', 'ttl_td' ),
            'installing'                      => __( 'Installing Plugin: %s', 'ttl_td' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'ttl_td' ),
            ...
            'return'                          => __( 'Return to Required Plugins Installer', 'ttl_td' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'ttl_td' ),
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'ttl_td' ), // %s = dashboard link.
