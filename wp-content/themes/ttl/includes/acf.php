...
if ( function_exists( 'acf_add_options_page' ) ) {
	$option_page = acf_add_options_page(
		array(
			'page_title' => __( 'Theme Options', 'ttl_td' ),
			'menu_title' => __( 'Theme Options', 'ttl_td' ),
...
function wysiwyg_render_field_settings( $field ) {
	acf_render_field_setting(
		$field,
		array(
			'label'        => __( 'Height of Editor', 'ttl_td' ),
			'instructions' => __( 'Height of Editor after Init', 'ttl_td' ),
			'name'         => 'wysiwyg_height',
			'type'         => 'number',
		)
	);
